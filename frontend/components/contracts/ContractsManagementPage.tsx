                  ...
                  paginated.map((row: ContractRecord) => {
                    ...
                    return (
                      <TableRow key={row.id} className={dashboardTableBodyRowClass}>
                        ...
                        <TableCell className={dashboardTableCellClass}>
                          <span className={dashboardTextSecondary}>
                            {row.startDate ? formatDate(String(row.startDate)) : "—"}
                            {row.endDate ? ` → ${formatDate(String(row.endDate))}` : ""}
                          </span>
                        </TableCell>
                        <TableCell className={dashboardTableCellClass}>
                          <span className={dashboardTextSecondary}>
                        ...
                        <TableCell className={dashboardTableCellClass}>
                          {latestDoc ? (
                            ...
                            <span className={dashboardTextSecondary}>—</span>
                          )}
                        </TableCell>
