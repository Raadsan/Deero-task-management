...
export const ROUTES = {
  ...
  uploadUserFile: (id: string) => `/staff/upload/${id}`,
  "my-tasks": "/tasks/my-tasks",
  "my-tasks-board": "/tasks/my-tasks/board",
  "my-tasks-today": "/tasks/my-tasks/today",
  "my-tasks-edit": (id: string) => `/tasks/my-tasks/edit/${id}`,
  notifications: "/tasks/notifications",
  createUser: "/staff/create",
  assignAnotherTask: (id: string) => `/tasks/create/${id}`,
  editUser: (id: string) => `/staff/edit/${id}`,
  logout: "/auth/login",
  clients: "/clients",
  contracts: "/contracts",
  recurringSchedules: "/tasks/recurring-schedules",
  ...
  reportsSalary: "/staff/report",
  userSalaryReport: `/staff/report`,
  clientReport: `/clients/report`,
  paySalary: (userId: string) => `/staff/pay/${userId}`,
...
export const SWR_CACH_KEYS = {
  ...
  recurringSchedules: {
    key: "/tasks/recurring-schedules/data",
  },
  reports: {
    key: "/reports/data",
  },
